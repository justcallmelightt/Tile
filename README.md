...
- 도구 → 피드백 보내기에서 아이디어 제안과 버그 신고를 작성할 수 있습니다. GitHub 계정으로 최종 등록하며, 등록한 이슈는 공개됩니다.
- 피드백 초안은 페이지 메모리에만 보관합니다. 버튼을 누르면 작성한 내용이 GitHub 이슈 작성 URL로 전달되므로 브라우저 기록에 남을 수 있습니다. 시간표·계정 정보는 자동으로 첨부하지 않습니다.
